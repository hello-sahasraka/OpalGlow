...
const ProductOverview = () => {
    ...
    const [quantity, setQuantity] = useState(1);
        ...
        useEffect(() => {
            if (state == "loading") {
                axios.get(import.meta.env.VITE_BACKEND_URL+"/api/product/getproductbyid/"+productId).then(
                    (response) => {
    ...
    <div className='w-full h-full'>
        ...
        {state === "loaded" && (
            <div className='w-full h-full px-4 md:px-[100px] py-10 flex flex-col justify-center md:flex-row gap-6'>
                ...
                <div className='w-full h-full flex flex-col md:flex-row gap-6 lg:h-[550px]'>
                    ...
                    {/* Image */}
                    <div className='w-full md:w-1/2 h-[300px] md:h-auto lg:h-full rounded-md'>
                    ...
                    <div className='w-full md:w-1/2 px-2 sm:px-4 flex flex-col justify-between gap-4 h-full md:h-full lg:h-4/5'>
                        ...
                        {product.altNames && product.altNames.length > 0 && (
                            <p className="text-sm text-gray-800 italic tracking-wide">
                                {product.altNames.join(' | ')}
                            </p>
                        )}

                        {/* Description */}
                        <p className="line-clamp-3 text-sm text-gray-700 leading-snug">
                            {product.description}
                        </p>
                        ...
                        <div className='w-full md:w-1/2'>
                            <div className="flex flex-col items-start gap-1">
                                <p className="text-rose-700 font-semibold text-2xl md:text-3xl">
                        ...
                        <div className='flex flex-col sm:flex-row gap-8 w-full md:w-2/3 mt-2'>
                            ...
                            className={`py-3 w-full sm:w-1/2 text-center rounded-md font-semibold text-sm cursor-pointer ${
                                product.stock > 0
        ...
        <div className="flex flex-col items-center justify-center h-full px-4 text-center">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-gray-600">
            <span className='text-4xl md:text-5xl text-rose-800'>Oops!</span><br />
            Product Not Found
          </h2>
